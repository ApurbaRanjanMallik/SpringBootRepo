...
public class SpringBootProj10MiniProjectOnSpringBootProfilesWithYMLApplication {
	@Bean(name = "c3p0")
	@Profile("uat")
	...
	public static void main(String[] args) throws Exception {
		ConfigurableApplicationContext context = SpringApplication
				.run(SpringBootProj10MiniProjectOnSpringBootProfilesWithYMLApplication.class, args);
